...
with t1:
    ...
    st.image(gerar_etiqueta_pequena(f"{px:08d}"), width=400, caption="Previa")
...
with t3:
    ...
    if codigos_lista:
        ...
        st.image(gerar_etiqueta_pequena(codigos_lista[0]), width=400, caption="Previa")
...
with t4:
    ...
    if itens_larga:
        ...
        st.image(gerar_etiqueta_larga(grupos[0]), use_container_width=True, caption="Previa")
